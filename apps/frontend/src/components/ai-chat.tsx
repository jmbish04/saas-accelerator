...
import { Card, Title, TextInput, Button, Callout } from "@tremor/react";
...
export function AIChat() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await permitAPI.askAI(userMessage.content);
    ...
    <Card className="p-6">
      ...
      <form onSubmit={handleSubmit} className="flex space-x-2">
        <TextInput
          ...
          placeholder="Ask about SF permits..."
          className="flex-1"
          disabled={loading}
        />
        <Button 
      ...
      <Callout title="AI Assistant Tips" className="mt-4">
